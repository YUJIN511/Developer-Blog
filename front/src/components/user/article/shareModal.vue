<template>
    <div class="container-share">
        <div class="modal-share ">
            <button class="btn-kakao" @click="sendKakao">
                <svg 
                    ...
                    <g>
                        ...
                        <path d="m14.308 14.204-.461 1.301h.922z" 
                        fill="#8ce1eb" data-original="#8CE1EB" 
                        class="" style="fill:#552F00" 
