      ...
      <div class="small-buttons">
        ...
        <button class="btn-library" @click="toggleLibraryBtn">
          ...
          >
            <g>
              <g>
                <path d="M24.4,4l-1.9-2.2C22.2,1.3,21.6,1,21,1H5C4.4,1,3.8,1.3,3.5,1.7L1.6,4C1.2,4.4,1,5,1,5.7v16.7C1,23.8,2.2,25,3.7,25h18.7
	...
	/>
        ...
        <button class="btn-share" @click="isShowShareModal = !isShowShareModal">
            <svg 
              ...
              xmlns="http://www.w3.org/2000/svg">
              <path d="m507.523438 148.890625-138.667969-144c-4.523438-4.691406-11.457031-6.164063-17.492188-3.734375-6.058593 2.453125-10.027343 
